...
#     connect <REPLACE_ME>; password <REPLACE_ME>
#

# These variables are for the manual workaround...
export EXT_SERVER_NAME=<REPLACE_ME>
export STEAM_GAME_KEY=<REPLACE_ME>
export GAME_SERVER_PASSWORD=<REPLACE_ME>
...
# start
cd "$INSTALL_DIR"
./srcds_run -game csgo -console -usercon +game_type 0 +game_mode 0 +mapgroup mg_active +map de_dust2 +sv_setsteamaccount "$STEAM_GAME_KEY" &
